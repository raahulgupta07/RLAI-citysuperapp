<script lang="ts">
  ...
  let authMethod = $state<'local' | 'ldap' | 'sso'>('ldap');
        ...
        <div class="login-form-card">
          ...
          {#if authMethod === 'sso'}
            ...
            <div class="sso-section">
              <div class="sso-info">You will be redirected to your identity provider</div>
              <button
              ...
              {#if !ssoEnabled}
                <div class="sso-disabled-note">Keycloak is not configured. Set KEYCLOAK_URL and KEYCLOAK_CLIENT_ID in .env</div>
              {/if}
            </div>
          {:else}
            <!-- Local / LDAP Mode -->
